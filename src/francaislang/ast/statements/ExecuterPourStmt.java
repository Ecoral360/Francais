 ...
 */
public class ExecuterPourStmt extends FrancaisLangStatement {
     ...
     * est appelée
     */
    public ExecuterPourStmt(Expression<?> nbEnoncesExpr, Expression<?> conditionExpr, Expression<?> nbEnoncesSautesExpr, ASCExecutor<FrancaisLangExecutorState> executeurInstance) {
