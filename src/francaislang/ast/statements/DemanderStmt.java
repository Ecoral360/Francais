 ...
 */
public class DemanderStmt extends FrancaisLangStatement {
     ...
     * est appel\u00E9e
     */
    public DemanderStmt(Expression<?> expression, ASCExecutor<FrancaisLangExecutorState> executorInstance) {
