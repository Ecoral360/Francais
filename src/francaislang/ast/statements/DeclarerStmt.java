 ...
 */
public class DeclarerStmt extends FrancaisLangStatement {
     ...
     * est appelée
     */
    public DeclarerStmt(VarExpr variable, @Nullable Expression<?> valeur, ASCExecutor<FrancaisLangExecutorState> executeurInstance) {
        super(executeurInstance);
        this.variable = variable;
        this.valeur = valeur == null ? new ConstValueExpr(FrancaisLangObj.AUCUNE_VALEUR) : valeur;
...
//        }
        ...
        scope.declareVariable(new ASCVariable<>(variable.nom(), value == null ? FrancaisLangObj.aucuneValeur() : value));
    }
