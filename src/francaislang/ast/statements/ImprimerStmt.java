 ...
 */
public class ImprimerStmt extends FrancaisLangStatement {
     ...
     * est appel\u00E9e
     */
    public ImprimerStmt(Expression<?> expression, ASCExecutor<FrancaisLangExecutorState> executorInstance) {
