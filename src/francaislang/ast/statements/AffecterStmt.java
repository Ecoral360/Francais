...
import francaislang.ast.expressions.GetProprieteExpr;
import francaislang.ast.expressions.IndexListeExpr;
 ...
 */
public class AffecterStmt extends FrancaisLangStatement {
     ...
     * est appelée
     */
    public AffecterStmt(Expression<?> variableExpr, @Nullable Expression<?> valeurExpr, ASCExecutor<FrancaisLangExecutorState> executeurInstance) {
        ...
        this.valeurExpr = valeurExpr == null ? new ConstValueExpr(FrancaisLangObj.AUCUNE_VALEUR) : valeurExpr;
    }
    ...
    public Object execute() {
        var valeur = (FrancaisLangObj<?>) this.valeurExpr.eval();
        if (variableExpr instanceof VarExpr varExpr) {
            ...
            variable.setAscObject((FrancaisLangObj<Object>) valeur);
